...
// Add SSL for Supabase (required) - simple string append to avoid URL parsing issues
if (databaseUrl && databaseUrl.includes('supabase') && !databaseUrl.includes('sslmode=')) {
