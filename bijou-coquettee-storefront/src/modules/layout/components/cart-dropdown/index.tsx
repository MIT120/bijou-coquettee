    ...
    >
      <Popover className="relative h-full">
        <PopoverButton className="h-full">
          ...
          >
            <span className="hidden small:inline">{t("cart.title", locale)}</span>
            <svg xmlns="http://www.w3.org/2000/svg" className="small:hidden h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
