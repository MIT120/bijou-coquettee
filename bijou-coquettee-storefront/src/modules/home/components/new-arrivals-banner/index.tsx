...
const NewArrivalsBanner = () => {
  return (
    <section className="w-full py-10 small:py-20 border-t border-grey-10 bg-gradient-to-r from-grey-90 to-grey-80 text-white">
      <div className="max-w-4xl mx-auto text-center space-y-4 small:space-y-6">
        ...
        >
          Открийте последните ни новости
        </Heading>
        <Text className="text-base small:text-lg text-white/80 font-light max-w-2xl mx-auto leading-relaxed">
          Разгледайте нашата най-нова колекция от ръчно изработени бижута,
          съчетаващи съвременен дизайн с вечна елегантност.
        </Text>
        <div className="pt-4">
