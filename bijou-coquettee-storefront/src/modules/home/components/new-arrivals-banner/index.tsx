  ...
  return (
    <section className="content-container py-10 small:py-20 border-t border-grey-10 bg-gradient-to-r from-grey-90 to-grey-80 text-white">
      <div className="max-w-4xl mx-auto text-center space-y-4 small:space-y-6">
        ...
        <Heading
          level="h2"
          className="text-3xl small:text-4xl large:text-5xl font-light tracking-tight"
        >
        ...
        <div className="pt-4">
          <LocalizedClientLink href="/store?sort=created_at">
            <Button
              size="large"
              className="bg-white hover:bg-grey-5 text-grey-90 px-8 py-3 rounded-none border border-white hover:border-grey-5 transition-all duration-300 font-light tracking-wide uppercase text-sm"
            >
              Shop New Arrivals
            </Button>
          </LocalizedClientLink>
